...
/**
 * The Controller class, implementing ActionListener, is where all the methods
 * are triggered according to which part of the GUI the user interacts with. The
 * ActionListener is the interface that allows the software to perform an
 * operation after some input from the user in the input windo.
 */
...
public class Controller implements ActionListener {
	...
	/**
	 * The class' constructor creates all the objects necessary to perform the
	 * operations that the user requires.
	 */
	...
	/**
	 * The actionPerformed method is implemented from the ActionListener interface.
	 * It allows for methods to run after an interaction with the user(an event)
	 * happens.
	 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals(gui.getiP().READ)) {
		...
		} else if (e.getActionCommand().equals(gui.getiP().UPDATE)) {
			String name = gui.getiP().getNameinput().getText();
			String lastname = gui.getiP().getLastnameinput().getText();
			String position = gui.getiP().getPositioninput().getText();
			String id = gui.getiP().getIdinput().getText();
			...
			cliente.agregar(aux);
		} else if (e.getActionCommand().equals(gui.getiP().DELETE)) {
			String name = gui.getiP().getNameinput().getText();
			String lastname = gui.getiP().getLastnameinput().getText();
			String position = gui.getiP().getPositioninput().getText();
			String id = gui.getiP().getIdinput().getText();
